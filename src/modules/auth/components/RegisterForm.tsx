        ...
        >
            {({
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="field">
                        <div className="control">
                            <input
                                ...
                                className={[
                                    'input',
                                    (errors.email && touched.email && errors.email) ? 'is-danger' : ''
                                ].join(" ")}
                                type="email"
                                disabled={isLoading}
                    ...
                    <div className="field">
                        <div className="control">
                            <input
                                ...
                                className={[
                                    'input',
                                    (errors.password && touched.password && errors.password) ? 'is-danger' : ''
                                ].join(" ")}
                                type="password"
                                disabled={isLoading}
                    ...
                    <div className="field">
                        <div className="control">
                            <button className="button is-primary is-fullwidth" disabled={isSubmitting || isLoading}>
                                Register
                            </button>
                        </div>
                    </div>
